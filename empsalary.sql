...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2020 at 09:40 PM
...
INSERT INTO `empsalary` (`EmpID`, `EmpName`, `EmpSalary`) VALUES
(1, 'Sally lu', 300000),
(2, 'John', 500000),
(3, 'David', 200000),
(4, 'Chandra', 800000);
...
--
ALTER TABLE `empsalary`
  MODIFY `EmpID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
